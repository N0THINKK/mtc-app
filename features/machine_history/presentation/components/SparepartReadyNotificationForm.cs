...
{
    public class SparepartReadyNotificationForm : Form
    {
        private AppLabel lblTitle;
        private AppLabel lblMessage;
        private AppButton btnOk;

        public SparepartReadyNotificationForm()
        {
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "✅ BARANG SUDAH SIAP!",
                Font = AppFonts.Header2,
                ForeColor = AppColors.Success, // Green
            ...
            {
                Text = "Sparepart yang Anda minta telah SIAP DI GUDANG.\nSilakan ambil sparepart tersebut sekarang.",
